...
"Overview\n"
"--------\n"
"Some features may be built directly.  Some features\n"
...
"restore your previously saved settings from \".menuconfig\" without\n"
...
static char filename[PATH_MAX+1] = ".menuconfig";
static int indent;
...
int main(int ac, char **av)
{
	...
	if (stat == 0) {
		conf_write(NULL);
		printf("\n\nConfiguration changes were save to .menuconfig\n");
	}
  else {
